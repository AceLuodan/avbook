  <tbody><tr style="font-weight:bold;">
             ...
             <tr onmouseover="this.style.backgroundColor='#F4F9FD';this.style.cursor='pointer';" onmouseout="this.style.backgroundColor='#FFFFFF'" style=" border-top:#DDDDDD solid 1px" height="35px"  >
                ...
                <td width="70%"  >
                	...
                	<a class="btn btn-mini-new btn-warning gotodown" v2="<?php echo 'magnet:?xt=urn:btih:'.$val['magnet_xt']."&dn=" .$val['magnet_name'] ?>"  v1="<?php echo $val['magnet_xt'] ?>" title="标志为待下载">addto115</a>  
                	<a class="btn btn-mini-new btn-warning gotodownnow" v2="<?php echo 'magnet:?xt=urn:btih:'.$val['magnet_xt']."&dn=" .$val['magnet_name'] ?>"  v1="<?php echo $val['magnet_xt'] ?>" title="addtothunder载">addtothunder</a>  
                	
                	 <?php endif; ?>   
                	 <?php  if($val['have_down']==1 ||$val['have_down']==3):?>
		    ...
		    <?php  foreach($res_mgbtso as $key=>$val): ?>
             <tr onmouseover="this.style.backgroundColor='#F4F9FD';this.style.cursor='pointer';" onmouseout="this.style.backgroundColor='#FFFFFF'" style=" border-top:#DDDDDD solid 1px" height="35px"  >
                ...
                <td width="70%"  >
                	    <?php echo 'magnet:?xt=urn:btih:'.$val['magnet_xt']."&dn=" .$val['magnet_name'] ?>
                ...
                <td width="70%"  >
                	   <a class="btn btn-mini-new btn-danger notdownall"  v2="<?php echo 'magnet:?xt=urn:btih:'.$val['magnet_xt']."&dn=" .$val['magnet_name'] ?>"  v1="<?php echo $val['magnet_xt'] ?>" title="取消已标志下载">取消标志</a>  
	...
	<!--	  -->
			...
			function ajaxremovemg(s,h){
		    	var t = "../ajaxremovemg/?magnet_xt="+s +"&have_down="+h   ;
		    ...
		    $('.gotodown').click(function (e) {  
		    	ajaxremovemg( $(this).attr("v1"),1);  
		    	}); 
		    $('.gotodownnow').click(function (e) {  
		    	ajaxremovemg( $(this).attr("v1"),3);  
		    ...
		    $('.notdown').click(function (e) {  
			    	...
			    	ajaxremovemg( $(this).attr("v1"),4);  
			    	}); 

		    $('.notdownall').click(function (e) {   
		    	 $('.notdown').click();
		    	 setTimeout(function(){
		    		 uncledatoolsbyajax();
			   		  }, 2000);
