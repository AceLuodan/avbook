        ...
        <?php  foreach($res_mg as $key=>$val): ?>
            ...
            <tr onmouseover="this.style.backgroundColor='#F4F9FD';this.style.cursor='pointer';" onmouseout="this.style.backgroundColor='#FFFFFF'" style=" border-top:#DDDDDD solid 1px" height="35px"  >
                <td width="70%"  >
                	...
                	<a class="btn btn-mini-new btn-warning gotodown" v2="<?php echo 'magnet:?xt=urn:btih:'.$val['magnet_xt']."&dn=" .$val['magnet_link']  ?>"  v1="<?php echo $val['magnet_xt'] ?>" title="标志为待下载">addto115</a>  
                	<a class="btn btn-mini-new btn-warning gotodownnow" v2="<?php echo 'magnet:?xt=urn:btih:'.$val['magnet_xt']."&dn=" .$val['magnet_link'] ?>"  v1="<?php echo $val['magnet_xt'] ?>" title="addtothunder载">addtothunder</a>  
